...
function SignInForm() {
    ...
    return (
        <div className="w-full space-y-4">
            {message && (
                <div className="p-3 sm:p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-700 dark:text-green-300 rounded-2xl text-sm font-medium">
                    {message}
                </div>
            )}
            {errorParam && (
            ...
            <div className={`overflow-hidden transition-all duration-300 ease-in-out ${showEmailForm ? 'max-h-[400px] opacity-100' : 'max-h-0 opacity-0'}`}>
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-[#0a0a12] p-4 sm:p-6 font-sans relative overflow-hidden selection:bg-purple-100 dark:selection:bg-purple-900/40 transition-colors duration-300">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-pink-200/30 dark:bg-pink-900/10 rounded-full blur-3xl"></div>
            </div>
