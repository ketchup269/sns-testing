    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-[100] flex items-center justify-center p-4 animate-in fade-in zoom-in-95" onClick={onClose}>
            <div className="bg-card rounded-3xl w-full max-w-4xl max-h-[85vh] shadow-2xl flex flex-col overflow-hidden relative" onClick={e => e.stopPropagation()}>
                <div className="flex items-center justify-between p-6 border-b border-card-border bg-gray-50/50 dark:bg-surface/50">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20 rounded-xl flex items-center justify-center leading-none">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                                    {historyItems.map((hist, idx) => (
                                        <div 
                                            ...
                                            className="group relative aspect-[4/5] bg-gray-200 dark:bg-gray-800 rounded-2xl overflow-hidden cursor-pointer shadow-sm hover:shadow-xl hover:ring-2 hover:ring-blue-500 hover:-translate-y-1 transition-all duration-300"
                                        >
